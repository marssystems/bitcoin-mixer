    ...
    <section class="mixer-container">
            ...
            <div class="mixer">
                <div class="step-four-content">
                    ...
                    <div class="order-content">
                        ...
                        <!-- <div class="light-box-shadow">
                            <div class="mixer-code-container">
                                <h5>@lang('start_mixing.smartmixer_code'): <span class="underlined">{{$order->code}}</span></h5>
                                <p>@lang('start_mixing.smartmixer_code_1')
                            </p></div>
                        </div> -->
        ...
        <div class="step-container container" id="step-5" style="display: {{ ($order_status->order->status == 'done') ? 'block' : 'none' }}">
            <div class="mixer step-five-content">
                ...
                <div class="duration">
                    <p class="center-align">@lang('start_mixing.transaction_done')</p>
                    <!-- <div class="timer">
                        <div class="time-container">
                            <span class="time" id="duration-days">00</span>
                            <span class="name" id="days-name">Days</span>
                        </div>
                        <span class="colon">:</span>
                        <div class="time-container">
                            <span class="time" id="duration-hours">00</span>
                            <span class="name" id="hours-name">Hours</span>
                        </div>
                        <span class="colon">:</span>
                        <div class="time-container">
                            <span class="time" id="duration-minutes">00</span>
                            <span class="name" id="minutes-name">Minutes</span>
                        </div>
                        <span class="colon">:</span>
                        <div class="time-container">
                            <span class="time" id="duration-seconds">00</span>
                            <span class="name" id="seconds-name">Seconds</span>
                        </div>
                    </div> -->
                </div>
                ...
                <!-- <div class="completed-actions">
                    ...
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>Mixing Order was generated</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>Anonymous Order Hash generated</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                    ...
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>Payment has been confirmed by the network</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>Your Sender Address is queued for deletion after completed mixing process</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>The order was assigned to the Smart Pool</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>The respective Receiver Addresses are queued for deletion. They are removed one by one after each mixing delay.</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>The entire order is queued for deletion after completion</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>Your BTC are reserved by the system for your mixing transaction<h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            <h6>Your coins are getting mixed</h6>
                        </div>
                    </div>
                    <div class="single-action-container">
                        <div class="single-action">
                            ...
                            <img src="/bundles/frontend/assets/images/mixer/bar/accept.svg" alt="">
                            <h6>You will receive your coins after the mixing delay <a
                                        href="/en/order/7go5ootphcow8wsc">
                                    This is your Mixing-Link <i
                                            class="material-icons">link</i></a></h6>
                        </div>
                    </div>
                </div> -->
